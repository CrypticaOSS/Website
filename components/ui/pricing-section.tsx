...
export const Component = () => {
  ...
  return (
    <section className="relative w-full bg-black py-24 font-sans text-white selection:bg-white selection:text-black sm:py-32">
      <div className="mx-auto max-w-6xl px-6 md:px-8">
        ...
        <div className="mb-16 flex flex-col items-center text-center">
          ...
          <p className="max-w-xl text-balance text-base text-neutral-400 sm:text-lg">
            Start for free, then pay only for what you use. No hidden fees, no complex tier structures. Just raw
            compute.
          </p>
          ...
          <div className="mt-10 flex items-center gap-3">
            ...
            <span
              className={cn("flex items-center gap-2 text-sm font-medium", isAnnual ? "text-white" : "text-neutral-500")}
            >
              Annually
        ...
        <div className="grid w-full grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div className="flex flex-col rounded-xl border border-white/[0.08] bg-[#050505] p-8 transition-colors hover:border-white/[0.15]">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-neutral-400">Yes</p>
            </div>
            ...
            <ul className="flex flex-col gap-4 text-sm text-neutral-300">
              {[
                "100,000 edge requests/mo",
                "3 global edge regions",
